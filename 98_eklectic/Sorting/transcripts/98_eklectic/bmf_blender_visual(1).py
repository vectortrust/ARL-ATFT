...
class BMFVisualization:
    ...
    def setup_materials(self):
        ...
        consciousness_mat.node_tree.clear()
        
        # Create emission shader for consciousness
        emission = consciousness_mat.node_tree.nodes.new(type='ShaderNodeEmission')
        emission.inputs['Color'].default_value = (1.0, 0.8, 0.2, 1.0)  # Golden
        emission.inputs['Strength'].default_value = 3.0
        
        output = consciousness_mat.node_tree.nodes.new(type='ShaderNodeOutputMaterial')
        ...
        love_mat.node_tree.clear()
        
        emission_love = love_mat.node_tree.nodes.new(type='ShaderNodeEmission')
        emission_love.inputs['Color'].default_value = (0.3, 0.1, 1.0, 1.0)  # Deep blue-purple
        emission_love.inputs['Strength'].default_value = 2.0
        
        output_love = love_mat.node_tree.nodes.new(type='ShaderNodeOutputMaterial')
        ...
        soul_mat.node_tree.clear()
        
        emission_soul = soul_mat.node_tree.nodes.new(type='ShaderNodeEmission')
        ...
        output_soul = soul_mat.node_tree.nodes.new(type='ShaderNodeOutputMaterial')
    ...
    def create_bmf_field_substrate(self):
        ...
        substrate_mat.node_tree.clear()
        
        emission = substrate_mat.node_tree.nodes.new(type='ShaderNodeEmission')
        emission.inputs['Color'].default_value = (0.1, 0.3, 0.6, 1.0)
        emission.inputs['Strength'].default_value = 0.5
        
        output = substrate_mat.node_tree.nodes.new(type='ShaderNodeOutputMaterial')
